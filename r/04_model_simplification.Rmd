...
Models are evaluated using the same train/test split and the same metrics as in the baseline analysis. Because response is rare, precision–recall AUC is the primary metric with ROC-AUC being used for context. Changes in performance are interpreted as tradeoffs rather than absolute improvements.
